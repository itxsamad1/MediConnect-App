      ...
      <View style={styles.header}>
        <View style={styles.userSection}>
          <View style={styles.avatarContainer}>
            <Image source={{ uri: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=100&h=100&fit=crop&crop=face' }} style={[styles.avatar, { borderColor: colors.success }]} />
        ...
        <View style={styles.rightSection}>
          <TouchableOpacity style={[styles.iconBtn, { backgroundColor: colors.surfaceSecondary, borderColor: colors.border }]}>
...
const styles = StyleSheet.create({
  container: { paddingTop: 50, paddingBottom: 15, elevation: 3 },
  ...
  healthRow: { flexDirection: 'row', paddingHorizontal: 20 },
